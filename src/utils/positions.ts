...
export const positions: PositionType[] = [
  { id: "window-1", x: 12, y: 32, angle: 0 },
  { id: "window-2", x: 32, y: 32, angle: 0 },
  { id: "window-3", x: 44, y: 32, angle: 0 },
  { id: "window-4", x: 55, y: 32, angle: 0 },
  { id: "window-5", x: 65, y: 32, angle: 0 },
  { id: "window-6", x: 75, y: 32, angle: 0 },
